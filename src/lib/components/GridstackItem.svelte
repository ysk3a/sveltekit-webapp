<script lang="ts">
	...
	// interface $$Props extends Partial<HTMLAttributes<any>> {
	// 	'gs-w': string;
	// 	'gs-h': string;
	// }
	// export let gs_w: string;
	...
	// }
	// interface WidgetItemAttribute extends WidgetItem {}
	// export let gsAttributes = {};
	export let widget: WidgetItem;
...
<br /><br /> -->
<div class="grid-stack-item" {...widget.gsAttributes}>
	<!-- following github.com/gridstack/gridstack.js/pull/1492 to make vscode happy-->
	<div class="grid-stack-item-content">
		...
		<!-- dynamic component -->
		<!-- <svelte:component this={widget.component} data={widget.data}/> -->
	</div>
</div>
